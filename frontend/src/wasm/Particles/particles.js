 ...
 * @param {number} click_add_count
 * @param {number} min_size
 * @param {number} max_size
 */
export function set_particle_config(initial_count, click_add_count, min_size, max_size) {
    wasm.set_particle_config(initial_count, click_add_count, min_size, max_size);
}
...
function __wbg_adapter_29(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h35ec62529eb84741(arg0, arg1);
}

const ParticleAnimationFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_particleanimation_free(ptr >>> 0, 1));
...
export class ParticleAnimation {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        ParticleAnimationFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_particleanimation_free(ptr, 0);
    }
    /**
    ...
    constructor(canvas_id) {
        ...
        const ret = wasm.particleanimation_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        ParticleAnimationFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    start() {
        const ret = wasm.particleanimation_start(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    stop() {
        wasm.particleanimation_stop(this.__wbg_ptr);
    }
}
